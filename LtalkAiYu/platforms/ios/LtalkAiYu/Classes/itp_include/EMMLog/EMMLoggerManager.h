...
+ (void)addFileLoggerWithTag:(id)tag;

+ (void)removeFileLoggerWithTag:(id)tag;

+ (void)rollLogFileWithTag:(id)tag completionBlock:(void (^)())completionBlock;

+ (NSArray *)sortedLogFilePathsWithTag:(id)tag;

+ (NSArray *)sortedLogFileNamesWithTag:(id)tag;

+ (NSString *)fileLoggerDirectoryWithTag:(id)tag;
